...
using System.IO; 
 class Ticket
    ...
    class TaskTicket : Ticket
    {
        ...
        public TaskTicket(string ticketID, string summary, string status, string priority, string submitter, string assigned, string watching, string projectName, DateTime dueDate)
            : base(ticketID, summary, status, priority, submitter, assigned, watching)
        {
